...
import OverviewTab from './IncentivesManagement/OverviewTab'
import PlansTab from './IncentivesManagement/PlansTab'
import StakeholdersTab from './IncentivesManagement/StakeholdersTab'
import ValuationsTab from './IncentivesManagement/ValuationsTab'
import MilestonesTab from './IncentivesManagement/MilestonesTab'
import SettingsTab from './IncentivesManagement/SettingsTab'

// Authorized emails that can access Incentives Management
...
const IncentivesManagement = () => {
    ...
    const handleTabChange = (tab) => {
        if (tab !== activeTab) {
            setActiveTab(tab)
            navigate(`/incentives-management?tab=${tab}`, { replace: true })
        }
    }
                    ...
                    <div className="bg-gradient-to-r from-white via-gray-50/30 to-white dark:from-gray-900 dark:via-gray-800/30 dark:to-gray-900 border-b border-gray-100 dark:border-gray-700/50">
                        <div className="px-4 lg:px-8 py-6 lg:py-8">
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
                                <div>
                                    <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white tracking-tight">Incentives Management</h1>
                                </div>
                            </div>
                        </div>
                    </div>
